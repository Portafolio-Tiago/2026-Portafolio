...
export const showcaseProjects: ShowcaseProject[] = [
  {
    ...
    description: 'Pagina institucional con foco en servicios, preguntas frecuentes y una navegacion clara para usuarios nuevos.',
  ...
  },
  {
    ...
    eyebrow: 'Hackathon',
    eyebrowEn: 'Hackathon',
    description: 'Landing page para la hackathon de mi colegio, con links a formulario e informacion del evento.',
